...
Centrale = PhotoImage(file="images/Centrale.png")
...
Reservoir = PhotoImage(file="images/Reservoir.png")
...
CentraleReservoir = PhotoImage(file="images/CentraleReservoir.png")
...
Liaison = PhotoImage(file="images/Liaison.png")
